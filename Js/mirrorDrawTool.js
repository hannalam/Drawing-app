function mirrorDrawTool() {
	...
	this.populateOptions = function() {
		select(".options").html(
			"<div>Pencil Width: <input type='range' id='pencilWidth'  min='1' max='50' step='1'>From 1 to 50<br><br><button id='directionButton' class='button'>Make Horizontal</button></div>");
